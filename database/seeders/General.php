    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    'name'  => 'admin_email',
                    'val'   => 'contact@appsplorer.com',
                    'group' => "general",
                ], [
                    'name'  => 'email_from_name',
                    'val'   => 'Appsplorer Travels',
                    'group' => "general",
                ], [
...
<a href="mailto:contact@appsplorer.com">contact@appsplorer.com</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => 'Copyright © 2019 by Appsplorer Travels',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Appsplorer Travels</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Appsplorer Travels</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2019 Appsplorer Travels. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Appsplorer Travels! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Appsplorer Travels</p>',
                    'group' => "user",
                ],
                [
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Appsplorer Travels Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
