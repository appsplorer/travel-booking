<form class="form bravo-form-register" method="post" action="{{route('auth.register.store')}}">
    ...
    <div class="form-group">
        <input type="password" class="form-control" name="password" autocomplete="off" placeholder="{{__('Password')}}" minlength="8">
    ...
    <div class="form-group">
        <label for="term">
            ...
            I have read and accept the <a href="https://travelbooking.servxsystem.com/page/privacy-policy" target='_blank'>Terms and Privacy Policy</a>
